...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://guarded-cliffs-28165.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var uploadUi = __webpack_require__(8);
	var uploadsApi = __webpack_require__(42);
	var authApi = __webpack_require__(43);
	var authUi = __webpack_require__(44);
	var moment = __webpack_require__(45);

	var getFormFields = __webpack_require__(163);
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  authApi.signUp(data).then(authUi.successSignUp).catch(authUi.failureSignUp);
	};

	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  authApi.signIn(data).then(authUi.signInSuccess).then(onShowAllUploads).catch(authUi.signInFail);
	};

	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  authApi.signOut(data).then(authUi.signOutSuccess).then(onShowLandingPage).catch(authUi.fail);
	};
	...
	var onShowAllUploads = function onShowAllUploads() {
	  uploadsApi.uploadOwners().then(function (data) {
	    // sort users in alphabetical order by email
	    data.users.sort(function (a, b) {
	      return alphaSort(a.email, b.email);
	    });
	...
	var putCurrentUserFirst = function putCurrentUserFirst(userArray) {
	  var currentUser = userArray.find(function (user) {
	...
	var onAddItem = function onAddItem(event) {
	  ...
	  uploadsApi.addItem(data).then(onFileUploaded).then(function () {
	    $('body').removeClass('modal-open');
	  }).catch();
	};

	// Show data about the upload in the update upload form
	var onUpdateUpload = function onUpdateUpload() {
	  event.preventDefault();
	  // Select data-id from target row
	  var id = $(this).attr('data-id');
	  // console.log('onUpdateUpload id', id)
	  // console.log(this)
	  uploadsApi.showUploadedData(id).then(uploadUi.fillUpdateUpload).then(onShowUpdateModal).catch();
	};
	...
	var onUpdateItem = function onUpdateItem(event) {
	  ...
	  var id = $(this).attr('data-id');
	  // console.log(id)
	  uploadsApi.updateItem(id, data).then(onFileUpdated).then(function () {
	    $('body').removeClass('modal-open');
	  }).catch();
	};
	...
	var onDeleteUpload = function onDeleteUpload() {
	  ...
	  uploadsApi.destroyItem(id).then(onFileDeleted).catch();
	};
	...
	var addChangePasswordHandlers = function addChangePasswordHandlers() {
	  $('#change-password').on('submit', onChangePassword);
	};

	// Show modal where user can upload a file
	var onShowUploadModal = function onShowUploadModal() {
	  // console.log('onShowUploadModal')
	  $('#add-item-modal').modal({ show: true });
	};

	var onCloseUploadModal = function onCloseUploadModal() {
	  $('#add-item')[0].reset();
	};
	...
	var onCloseUpdateModal = function onCloseUpdateModal() {
	  $('#update-item')[0].reset();
	};

	var onShowSignOut = function onShowSignOut() {
	  // console.log('onShowSignOut')
	  uploadUi.showSignOut();
	  addSignOutHandlers();
	};

	var addSignOutHandlers = function addSignOutHandlers() {
	...
	var onUserFolder = function onUserFolder(e) {
	  var target = $(e.target).closest('tr');
	  renderUserFolders(target);
	};
	var onUserFolderBreadcrumb = function onUserFolderBreadcrumb(e) {
	  var target = $(e.target);
	  renderUserFolders(target);
	};
	var renderUserFolders = function renderUserFolders(target) {
	  var folder = target.data('folder');
	  var id = target.data('id');
	  store.folder = folder;
	  uploadsApi.userFolders(id).then(function (data) {
	    data.folders.sort().reverse();
	    onShowHomePage(data);
	  }).catch();
	};
	var onDateFolder = function onDateFolder(e) {
	  var target = $(e.target).closest('tr');
	  var id = target.data('id');
	  var path = target.data('folder');
	  renderFolderDocuments(path, id);
	};

	var onFileUpdated = function onFileUpdated(e) {
	  // when a file is updated, just reload the current folder view
	  var id = store.user.id;
	  var path = $('#current-folder').text();
	  renderFolderDocuments(path, id);
	};
	var onFileUploaded = function onFileUploaded(e) {
	  ...
	  var path = moment().format('MM-DD-YYYY');
	  renderFolderDocuments(path, id);
	};
	var onFileDeleted = function onFileDeleted(e) {
	  // when a file is deleted, reload the view
	  var id = store.user.id;
	  var path = $('#current-folder').text();
	  renderFolderDocuments(path, id);
	};
	var renderFolderDocuments = function renderFolderDocuments(path, id) {
	  uploadsApi.folderDocuments(path, id).then(function (data) {
	    ...
	    if (data.uploads.length === 0) {
	      ...
	      data.uploads = data.uploads.map(function (upload) {
	      ...
	      data.uploads.sort(function (a, b) {
	        return dateSort(a.createdAt, b.createdAt);
	      });
	      onShowHomePage(data);
	    }
	  }).catch();
	...
	var onClosePassModal = function onClosePassModal() {
	  $('.pass-success-message').hide();
	  $('.old-password-mismatch-message').hide();
	...
	var onOpenFile = function onOpenFile(e) {
	  var target = $(e.target);
	  var url = target.closest('td').data('url');
	...
	module.exports = {
	  ...
	  onShowAllUploads: onShowAllUploads
	  // uploadHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showHomePageTemplate = __webpack_require__(9);
	var showLandingPageTemplate = __webpack_require__(37);
	var showSignOutTemplate = __webpack_require__(40);
	var store = __webpack_require__(41);
	...
	var fillUpdateUpload = function fillUpdateUpload(data) {
	...
	var showSignOut = function showSignOut() {
	...
	module.exports = {
	  ...
	  fillUpdateUpload: fillUpdateUpload,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(29),depth0,{"name":"list-view","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"3":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = container.invokePartial(__webpack_require__(30),depth0,{"name":"users-view","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"5":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = container.invokePartial(__webpack_require__(31),depth0,{"name":"user-folder-list-view","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

	  return "<!-- <h2>placeholder for home page</h2> -->\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"nav-bar-view","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"add-upload-button","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + ((stack1 = container.invokePartial(__webpack_require__(35),depth0,{"name":"add-item-view","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + ((stack1 = container.invokePartial(__webpack_require__(36),depth0,{"name":"update-item-view","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.uploads : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    ...
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.folders : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr class=\"clickable\">\n      <td style=\"text-align:center\" data-url=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    + "\" class=\"file file-path clickable\">\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.isImage : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "      </td>\n\n      <td data-url=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    ...
	    + "</span>\n      </td>\n\n    <td data-url=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    + "\" class=\"file-path date clickable\">"
	    ...
	    + "</td>\n\n        <td style=\"text-align:right;\" class=\"file\">\n            <a href=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    + "\" download class=\"btn btn-default\" aria-hidden=\"true\">\n              <span class=\"glyphicon glyphicon-download\"></span>\n            </a>\n"
	  ...
	  return "        <button type=\"button\" class=\"btn btn-default update-button\" data-id=\""
	  ...
	  return "<div class=\"table-container\">\n<div class='breadcrumb'>\n<a id=\"show-users\" >Home</a>\n  <span class=\"glyphicon glyphicon-chevron-right\"></span>\n <a id=\"user-folders\" data-folder=\""
	    + alias4(((helper = (helper = helpers.folder || (depth0 != null ? depth0.folder : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"folder","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\" data-id=\""
	    + alias4(alias5(((stack1 = ((stack1 = (depth0 != null ? depth0.uploads : depth0)) != null ? stack1["0"] : stack1)) != null ? stack1._owner : stack1), depth0))
	    + "\">"
	    + alias4(((helper = (helper = helpers.folder || (depth0 != null ? depth0.folder : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"folder","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "</a>\n <span class=\"glyphicon glyphicon-chevron-right\"></span>\n <span id=\"current-folder\">"
	    + alias4(alias5(((stack1 = ((stack1 = (depth0 != null ? depth0.uploads : depth0)) != null ? stack1["0"] : stack1)) != null ? stack1.path : stack1), depth0))
	    + "</span>\n</div>\n\n<table class=\"table table-responsive\" style=\"float:right\">\n<thead class=\"thead-default\">\n  <tr>\n    <th>Preview</th>\n    <th style=\"padding-left: 15px;\">Name</th>\n    <th>Created</th>\n    <th>Updated</th>\n    <th style=\"text-align:center\" >Actions</th>\n  </tr>\n  </thead>\n  <tbody>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.uploads : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n</table>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "      <span data-placement=\"right\" title=\"Looking for your folder? Upload a file to see it display.\"\n      data-toggle=\"tooltip\" class=\"glyphicon glyphicon-question-sign\"></span>\n";
	},"3":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "    <tr data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class='user-folder clickable' data-folder=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.email : stack1), depth0))
	    + "\">\n      <td>\n        <span class=\"glyphicon glyphicon-folder-close\" aria-hidden=\"true\"></span>\n      <span>\n        "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.email : stack1), depth0))
	    + "\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.isCurrentUserFolder : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n      </span>\n    </td>\n    </tr>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "        (you)\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"table-container\">\n<div class='breadcrumb'>\nHome\n</div>\n<table class=\"table table-responsive\" style=\"float:right\">\n<thead class=\"thead-default\">\n  <tr>\n    <th style= \"text-align:left\">\n      Users\n"
	    + ((stack1 = helpers.unless.call(alias1,((stack1 = ((stack1 = (depth0 != null ? depth0.users : depth0)) != null ? stack1["0"] : stack1)) != null ? stack1.isCurrentUserFolder : stack1),{"name":"unless","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </th>\n\n  </tr>\n  </thead>\n  <tbody>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.users : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n</table>\n</div>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
	  ...
	  return "    <tr data-folder=\""
	    + alias2(alias1(blockParams[0][0], depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = (depths[1] != null ? depths[1].user : depths[1])) != null ? stack1.id : stack1), depth0))
	  ...
	  return "<div class=\"table-container\">\n<div class='breadcrumb'>\n<a id=\"show-users\">Home</a>\n<span class=\"glyphicon glyphicon-chevron-right\"></span>\n<span id=\"current-folder\">"
	    ...
	    + "</span>\n</div>\n<table class=\"table table-responsive\" style=\"float:right\">\n<thead class=\"thead-default\">\n  <tr>\n    <th  style= \"text-align:left\">Folders</th>\n  </tr>\n  </thead>\n  <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.folders : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams, depths),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n</table>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- NAV BAR -->\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(33),depth0,{"name":"change-password-view","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "<!-- <nav class=\"navbar navbar-default navbar-fixed-top\"> -->\n<nav class=\"navbar navbar-default navbar-fixed-top\">\n  <div class=\"container\">\n    <div class=\"navbar-header\">\n      <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar\" aria-expanded=\"false\" aria-controls=\"navbar\">\n         <span class=\"sr-only\">Toggle Navigation</span>\n         <span class=\"glyphicon glyphicon-menu-hamburger\" aria-hidden=\"true\"></span>\n       </button>\n      <p class=\"navbar-brand\">all the things</p>\n    </div>\n    <div id=\"navbar\" class=\"navbar-collapse collapse\" aria-expanded=\"false\" style=\"height:1px;\">\n      <ul class=\"nav navbar-nav navbar-right\">\n        <li class=\"active\">\n          <a href=\"#\" id=\"change-pwd-option\">Change Password</a>\n        </li>\n        <li class=\"active\">\n          <a href=\"#\" id=\"sign-out-option\">Sign Out</a>\n        </li>\n      </ul>\n    </div>\n  </div>\n</nav>\n";
	},"usePartial":true,"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"add-upload\">\n  <button class=\"mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect add-upload\" id=\"add-upload-button\">\n    <i class=\"material-icons\">add</i>\n  </button>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"add-item\">\n  <fieldset>\n    <div id=\"add-item-modal\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\">\n      <div class=\"modal-dialog\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h3>Upload File <span class=\"extra-title muted\"></span></h3>\n          </div>\n          <div class=\"modal-body form-horizontal\">\n            <div class=\"control-group\">\n              <label for=\"upload_title\" class=\"control-label\">Title</label>\n              <div class=\"controls\">\n                <input type=\"text\" name=\"image[title]\" placeholder='140 character limit' maxlength=140 required>\n              </div>\n            </div>\n            <div class=\"control-group\">\n              <div class=\"controls\">\n                <input type=\"file\" name=\"image[file]\" required>\n              </div>\n            </div>\n          </div>\n          <div class=\"modal-footer\">\n            <button type=\"button\" class=\"btn close-upload-modal\" data-dismiss=\"modal\" aria-hidden=\"true\">Close</button>\n            <button type=\"submit\" class=\"btn btn-primary\">Upload</button>\n          </div>\n        </div>\n      </div>\n    </div>\n  </fieldset>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"update-item\">\n  <fieldset>\n    <div id=\"update-item-modal\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\">\n      <div class=\"modal-dialog\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h3>Update File <span class=\"extra-title muted\"></span></h3>\n          </div>\n          <div class=\"modal-body form-horizontal\">\n            <div class=\"control-group\">\n              <label for=\"update_title\" class=\"control-label\">Title</label>\n              <div class=\"controls\">\n                <input type=\"text\" name=\"upload[title]\" id=\"update-upload-title\"  maxlength=140 required>\n              </div>\n            </div>\n          </div>\n          <div class=\"modal-footer\">\n            <button type=\"button\" class=\"btn close-update-modal\" data-dismiss=\"modal\" aria-hidden=\"true\">Close</button>\n            <button type=\"submit\" class=\"btn btn-primary\" id=\"submit-update-form-button\">Update</button>\n          </div>\n        </div>\n      </div>\n    </div>\n  </fieldset>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(38),depth0,{"name":"sign-up-view","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + ((stack1 = container.invokePartial(__webpack_require__(39),depth0,{"name":"sign-in-view","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- SIGN UP FORM -->\n<div class=\"jumbotron\" id=\"sign-up-jumbotron\">\n  <h1 class=\"big-headers\">all the things</h1>\n  <form id=\"sign-up\" class=\"auth-login-form\">\n    <fieldset>\n      <div class=\"input-group center-block\">\n        <input type=\"text\" name=\"credentials[email]\" value=\"\" placeholder=\"email\" id=\"sign-up-email\" class=\"form-control\" required>\n        <input type=\"password\" name=\"credentials[password]\" value=\"\" placeholder=\"password\" id=\"sign-up-password\" class=\"form-control\" required>\n        <input type=\"password\" name=\"credentials[password_confirmation]\" value=\"\" placeholder=\"confirm password\" id=\"sign-up-confirm\" class=\"form-control\" required>\n        <input type=\"submit\" name=\"submit\" value=\"Sign Up!\" class=\"btn btn-primary btn-md\" id=\"sign-up-button\">\n      </div>\n\n      <div class=\"auth-responses\" id=\"sign-up-response\">&nbsp;</div>\n    </fieldset>\n  </form>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- SIGN IN FORM -->\n<div class=\"jumbotron\" id=\"sign-in-jumbotron\">\n  <form id=\"sign-in\" class=\"auth-login-form\">\n    <fieldset>\n      <div class=\"input-group center-block\">\n        <input type=\"text\" name=\"credentials[email]\" value=\"\" placeholder=\"email\" id=\"sign-in-email\" class=\"form-control\" required>\n        <input type=\"password\" name=\"credentials[password]\" value=\"\" placeholder=\"password\" id=\"sign-in-password\" class=\"form-control\" required>\n        <input type=\"submit\" name=\"submit\" value=\"Sign In!\" class=\"btn btn-primary btn-md\" id=\"sign-in-button\">\n      </div>\n\n      <div class=\"auth-responses\" id=\"sign-in-response\">&nbsp;</div>\n    </fieldset>\n  </form>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- SIGN OUT -->\n<div class=\"jumbotron\" id=\"sign-out-jumbotron\">\n  <form id=\"sign-out\" class=\"auth-login-form\">\n    <fieldset>\n      <div class=\"input-group center-block\">\n        <input type=\"submit\" name=\"submit\" value=\"Sign Out\" class=\"btn btn-primary btn-md form-control\">\n      </div>\n\n      <div class=\"auth-responses\" id=\"sign-out-response\">&nbsp;</div>\n    </fieldset>\n  </form>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showAllUploads = function showAllUploads() {
	  return $.ajax({
	...
	var showUploadedData = function showUploadedData(id) {
	...
	var uploadOwners = function uploadOwners() {
	  return $.ajax({
	...
	var userFolders = function userFolders(owner) {
	  return $.ajax({
	...
	var folderDocuments = function folderDocuments(path, owner) {
	  return $.ajax({
